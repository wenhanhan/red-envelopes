<template>
  <div class="app-container">
      ...
      <el-table
            ...
            class="trace-table"
            style="width: 100%">
            <el-table-column prop="CreateDateTime" align="center" label="操作时间"></el-table-column>
            <el-table-column prop="OperateText" align="center" label="操作事件"></el-table-column>
            <el-table-column prop="UserName" align="center" label="操作用户"></el-table-column>
      </el-table>
      <pagination
        v-show="+total>10"
        :total="+total"
