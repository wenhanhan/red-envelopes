<template>
  <div class="app-container">
      ...
      <el-table
            ...
            class="trace-table"
            style="width: 100%">
            <el-table-column prop="CreateDateTime" align="center" label="发放失败时间"></el-table-column>
            ...
            <el-table-column show-overflow-tooltip prop="WeiXinResult" align="center" label="失败原因"></el-table-column>
      </el-table>
      <pagination
        v-show="+total>10"
        :total="+total"
