<template>
  <div class="app-container">
          ...
          <el-col :span="4">
            <el-card shadow="always">
              <div class="card-box">
                ...
                <div class="card-box-items">{{base_info.ShowCount.nowcount}}</div>
              </div>
            </el-card>
          </el-col>
        </el-row>
    ...
    <el-row style="margin-bottom:15px;font-size:20px" type="flex" justify="start">
        <el-divider style="font-size:20px"><i class="el-icon-s-data" style="margin-right:10px"></i>微信红包支出报表</el-divider>
    </el-row>
